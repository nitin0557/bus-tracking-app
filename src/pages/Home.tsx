        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-sm mt-2">
              Fast, Affordable & Reliable Bus Service
            </p>
          </div>
          <div
            onClick={() => {
          ...
          {jsonArray.map((bus) => (
            <div key={bus.id} className="rounded-xl overflow-hidden">
              ...
              <div className="mt-4">
                ...
                <button className="mt-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-purple-600 hover:to-blue-600 text-white px-6 py-3 rounded-xl transition-all">
                  Book Now
                </button>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 text-center">
          <div className="bg-gradient-to-br from-blue-100 to-purple-100 p-4 rounded-xl shadow hover:shadow-xl transition">
            ...
            <p className="text-gray-700">
              All buses equipped with AC, Wi-Fi, and comfy seats.
            </p>
          </div>
          <div className="bg-gradient-to-br from-blue-100 to-purple-100 p-4 rounded-xl shadow hover:shadow-xl transition">
            <img
              src={jsonArray[0].image}
              alt="On Time"
              className="w-full h-32 object-cover rounded mb-2"
            />
      ...
      <section id="testimonials" className="p-6">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-white p-4 rounded-xl shadow hover:shadow-xl transition">
            <img
              src="https://plus.unsplash.com/premium_photo-1689530775582-83b8abdb5020?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="boy"
            />
          ...
          <div className="bg-white p-4 rounded-xl shadow hover:shadow-xl transition">
            ...
            />
            <p className="text-gray-700 italic">
              “Booking tickets online was super easy and hassle-free. Highly
              recommended!”
            </p>
